...
<div class="page-wrapper">
  ...
  <main>
    ...
    <form class="form container <?= !empty($errors) ? 'form--invalid' : '*' ?>" action="/templates/auth.php" method="post" autocomplete="off"> <!-- form
    --invalid -->
      <h2>Регистрация нового аккаунта</h2>
      <div class="form__item <?= !empty($errors['form__error']) ? 'form__item--invalid' : 'form__error' ?>"> <!-- form__item--invalid -->
        <label for="email">E-mail <sup>*</sup></label>
        <input id="email" type="text" name="email" placeholder="Введите e-mail">
        <span class="form__error <?= !empty($errors['form__error']) ? 'form__item--invalid' : 'form__error' ?>">Введите e-mail</span>
      </div>
